...
class Data {
	...
	public static function get_data_option() {
		$option = get_option( WVR_OPTION, true );
		$data   = apply_filters( 'wvr_default_data', self::$data );

		return wp_parse_args( $option, $data );
	}
