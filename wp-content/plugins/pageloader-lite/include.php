...
<div class="bonfire-pageloader-background<?php if(is_singular() ) { ?> <?php echo $bonfire_pageloader_display; ?><?php } ?>">
</div>
<!-- END THE BACKGROUND -->
...
<div class="bonfire-pageloader-icon-wrapper<?php if(is_singular() ) { ?> <?php echo $bonfire_pageloader_display; ?><?php } ?>">
    <div class="bonfire-pageloader-icon">
            ...
            <?php if( get_theme_mod('pageloader_custom_loading_image') != '' ) { ?>
                <div class="icon-wrapper"><img src="<?php echo get_theme_mod('pageloader_custom_loading_image'); ?>" class="<?php if( get_theme_mod('bonfire_pageloader_fade_animation') != '') { ?>pageloader-animate-fade <?php } ?><?php $bonfire_pageloader_animation_speed = get_theme_mod( 'pageloader_animation_speed' ); if( $bonfire_pageloader_animation_speed != '' ) { switch ( $bonfire_pageloader_animation_speed ) { case 'slow': echo 'pageloader-iconspeedslow'; break; case 'fast': echo 'pageloader-iconspeedfast'; break; case 'none': echo 'pageloader-iconspeednone'; break; }} ?> pageloader-clockwise"></div>
            <?php } else { ?>
                <div class="pageloader-iconsize100 <?php $bonfire_pageloader_icon_size = get_theme_mod( 'pageloader_icon_size' ); if( $bonfire_pageloader_icon_size != '' ) { switch ( $bonfire_pageloader_icon_size ) { case '25': echo 'pageloader-iconsize25'; break; case '50': echo 'pageloader-iconsize50'; break; case '75': echo 'pageloader-iconsize75'; break; }} ?>">
                    ...
                    <div class="icon-wrapper"><svg class="<?php if( get_theme_mod('bonfire_pageloader_fade_animation') != '') { ?>pageloader-animate-fade <?php } ?><?php $bonfire_pageloader_animation_speed = get_theme_mod( 'pageloader_animation_speed' ); if( $bonfire_pageloader_animation_speed != '' ) { switch ( $bonfire_pageloader_animation_speed ) { case 'slow': echo 'pageloader-iconspeedslow'; break; case 'fast': echo 'pageloader-iconspeedfast'; break; case 'none': echo 'pageloader-iconspeednone'; break; }} ?> pageloader-clockwise" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
