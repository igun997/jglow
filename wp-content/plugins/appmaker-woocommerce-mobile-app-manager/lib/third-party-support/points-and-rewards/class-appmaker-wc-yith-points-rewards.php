...
class APPMAKER_WC_YITH_POINTS_AND_REWARDS extends APPMAKER_WC_REST_Controller
{
    ...
    public function updateCartMeta( $meta ) {
           ...
           if (YITH_WC_Points_Rewards()->get_option('enabled_cart_message') == 'yes' && YITH_WC_Points_Rewards()->is_user_enabled() && $show_cart_messages && YITH_WC_Points_Rewards()->is_enabled() ) {
               ob_start();
