...
<div class="fixed-footer">
	...
	<?php if ( $show_login_step ) : ?>
		<button id="appmakercheckout-next" class="<?php echo $buttons_class; // phpcs:ignore ?> button-active appmakercheckout-nav-button" type="button"><?php echo $options['t_next']; // phpcs:ignore ?></button>
